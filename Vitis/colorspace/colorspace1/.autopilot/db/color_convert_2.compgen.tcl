...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_TVALID { I 1 bit } stream_in_TREADY { O 1 bit } stream_in_TLAST { I 1 vector } } \
} "
} else {
...
# RegSlice definition:
set ID 9
set RegSliceName color_convert_2_regslice_both
set RegSliceInstName color_convert_2_regslice_both_U
set CoreName ap_simcore_color_convert_2_regslice_both
