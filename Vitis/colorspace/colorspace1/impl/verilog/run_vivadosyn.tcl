...
set ip_vlnv mac:jpeg:color_convert_2:0.5
set ip_repo_path ../ip
...
dict set report_options hls_project colorspace
dict set report_options hls_solution colorspace1
...
dict set report_options bindmodules color_convert_2_regslice_both
